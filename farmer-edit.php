...
<div class="py-4">
           ...
           if(mysqli_num_rows($query_run) > 0)
           {
            ...
            <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="fname" class="form-control"  value="<?=$farmer['fname'];?>" required>
            ...
            <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="lname" class="form-control" value="<?=$farmer['lname'];?>" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-select"  name="state" aria-label="Default select example" value="<?=$farmer['state'];?>"  required>
  ...
  <option value="karnataka">Karnataka</option>
                    ...
                    <div class="from-group text-center">
                        <button type="submit" name="update_btns" class="btn btn-primary">Update</button>
